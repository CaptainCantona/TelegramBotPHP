...
class Telegram
{
	...
	// added by @ark_1996 //start
	const USER_FORWARDED = 'user_forwarded';
	const CHANNEL_FORWARDED = 'channel_forwarded';
	const BOT_FORWARDED = 'bot_forwarded';
	...
	* </table>
	...
	// added by MOHSEN //end
	// added by @ark_1996 //start
	public function getForwardedType(){
		$update = $this->data;
		if ($update['message']['forward_from_chat']['type']=="channel") {
            return self::CHANNEL_FORWARDED;
        }
		if ($update['message']['forward_from']['is_bot']==true) {
            return self::BOT_FORWARDED;
        }
		if (isset($update['message']['forward_from']) || isset($update['message']['forward_sender_name'])) {
            return self::USER_FORWARDED;
        }
	}
	public function ifForwarded(){
		$update = $this->data;
		if (isset($update['message']['forward_from']) || isset($update['message']['forward_from_chat']) || isset($update['message']['forward_sender_name'])) {
